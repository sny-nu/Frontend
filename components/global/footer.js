...
export default function Footer () {
    return (
        <div className="lg:container mx-auto h-auto md:h-24 bg-gray-900 text-gray-400 flex text-sm items-center justify-between flex-col md:flex-row lg:px-12 py-6 px-6">
