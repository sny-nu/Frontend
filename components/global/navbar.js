    ...
    return (
        <nav className="lg:container mx-auto bg-gray-900 w-full lg:px-6 antialiased max-w-xl">
            <div className="flex items-center justify-between px-6 py-3 h-24">
                ...
                <div className={isOpen == true ? "z-40 fixed top-0 left-0 h-full w-full bg-gray-900 flex flex-col justify-center" : "hidden"}>
                ...
                <div className="md:hidden z-50">
                    <button type="button" onClick={changeMobileNav} className="block text-gray-500 pr-3 hover:text-white focus:text-white focus:outline-none">
