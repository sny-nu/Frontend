    ...
    return(
        <Layout>
            ...
            <div className="lg:container mx-auto bg-gray-900 w-full lg:px-12 antialiased max-w-xl px-6 text-white">
                ...
                <p>Some of the information we collect is directly from you via the Website and Services. However, we may also collect Personal Information 
                ...
                <p>We may use cookies to collect, store, and track information for statistical purposes to operate the Website and Services. 
